...
@Component({
  selector: 'app-pipeline-pilot',
  standalone: true,
  imports: [CommonModule, RouterLink, AvatarDropdownComponent],
  template: `
    <div class="launchpad-page">
      <!-- Animated Background -->
      <div class="absolute inset-0 bg-gradient-to-br from-emerald-950 via-teal-900 to-cyan-950"></div>
      ...
      <!-- Gradient Orbs -->
      <div class="gradient-orb orb-primary" style="background: radial-gradient(circle, #10b981 0%, transparent 70%);"></div>
      <div class="gradient-orb orb-secondary" style="background: radial-gradient(circle, #14b8a6 0%, transparent 70%);"></div>
      <div class="gradient-orb orb-accent" style="background: radial-gradient(circle, #34d399 0%, transparent 70%);"></div>
        ...
        <div class="container mx-auto px-6 py-4">
          <div class="flex items-center justify-between max-w-7xl mx-auto">
            <a routerLink="/" class="flex items-center gap-3 group">
              <div class="relative">
                <div class="absolute -inset-1 bg-gradient-to-r from-emerald-600 to-teal-500 rounded-full blur opacity-30 group-hover:opacity-50 transition duration-500"></div>
              ...
              <span class="text-xl font-black tracking-tight text-white hidden sm:block">
                ROCKET<span class="text-emerald-400">GOALS</span>
              </span>
            </a>
            ...
            <div class="flex items-center gap-4">
              ...
              @if (isLoggedIn()) {
                ...
                <a routerLink="/signup" class="px-5 py-2 bg-emerald-600 text-white text-sm font-bold rounded-full hover:bg-emerald-500 transition-colors shadow-lg shadow-emerald-600/30">
                  Get Started
                </a>
              }
            </div>
      ...
      <main class="hero-section container mx-auto px-6">
        <div class="max-w-5xl mx-auto text-center">
          ...
          <div class="hero-badge">
            <span class="hero-badge-dot" style="background: #10b981; color: #10b981;"></span>
          ...
          <!-- Tagline -->
          <p class="hero-tagline bg-gradient-to-r from-emerald-400 to-teal-400 bg-clip-text text-transparent">
            {{ template.tagline }}
          </p>
          ...
          <div class="cta-section">
            <button 
              ...
              class="launch-btn"
              style="background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: white; box-shadow: 0 20px 60px rgba(16, 185, 129, 0.4);">
              @if (isLaunching()) {
                <span class="spinner"></span>
                <span>Building Pipeline...</span>
              } @else {
                <span>📈</span>
                <span>Accelerate Deals</span>
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            @if (!isLoggedIn()) {
              <p class="mt-6 text-sm text-white/40">
                You'll create an account to start closing deals
              </p>
            }
          </div>
        </div>
  ...
  styles: [`
    ...
    .chart-lines::before {
      ...
      left: -50%;
      background: 
        linear-gradient(90deg, transparent 49%, rgba(16, 185, 129, 0.3) 50%, transparent 51%),
        linear-gradient(0deg, transparent 49%, rgba(16, 185, 129, 0.3) 50%, transparent 51%);
...
export class PipelinePilotComponent implements OnInit {
  ...
  protected readonly template: LaunchpadTemplate = LAUNCHPAD_TEMPLATES['pipeline-pilot'];
