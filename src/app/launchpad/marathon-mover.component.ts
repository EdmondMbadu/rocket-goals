...
@Component({
  selector: 'app-marathon-mover',
  standalone: true,
  imports: [CommonModule, RouterLink, AvatarDropdownComponent],
  template: `
    <div class="launchpad-page">
      <!-- Animated Background -->
      <div class="absolute inset-0 bg-gradient-to-br from-amber-950 via-orange-900 to-red-950"></div>
          ...
          <div class="flex items-center justify-between max-w-7xl mx-auto">
            <a routerLink="/" class="flex items-center gap-3 group">
              ...
              <span class="text-xl font-black tracking-tight text-white hidden sm:block">
                ROCKET<span class="text-orange-400">GOALS</span>
              </span>
            </a>
          ...
          <div class="cta-section">
            ...
            @if (!isLoggedIn()) {
              <p class="mt-6 text-sm text-white/40">
                You'll create an account to cross the finish line
              </p>
            }
          </div>
        </div>
...
export class MarathonMoverComponent implements OnInit {
  ...
  protected readonly template: LaunchpadTemplate = LAUNCHPAD_TEMPLATES['marathon-mover'];
