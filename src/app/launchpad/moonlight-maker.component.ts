...
@Component({
  selector: 'app-moonlight-maker',
  standalone: true,
  imports: [CommonModule, RouterLink, AvatarDropdownComponent],
  template: `
    <div class="launchpad-page">
      <!-- Animated Background -->
      <div class="absolute inset-0 bg-gradient-to-br from-blue-950 via-indigo-950 to-slate-950"></div>
      ...
      <!-- Gradient Orbs -->
      <div class="gradient-orb orb-primary" style="background: radial-gradient(circle, #6366f1 0%, transparent 70%);"></div>
      <div class="gradient-orb orb-secondary" style="background: radial-gradient(circle, #4f46e5 0%, transparent 70%);"></div>
      <div class="gradient-orb orb-accent" style="background: radial-gradient(circle, #818cf8 0%, transparent 70%);"></div>
        ...
        <div class="container mx-auto px-6 py-4">
          <div class="flex items-center justify-between max-w-7xl mx-auto">
            <a routerLink="/" class="flex items-center gap-3 group">
              <div class="relative">
                <div class="absolute -inset-1 bg-gradient-to-r from-indigo-600 to-blue-500 rounded-full blur opacity-30 group-hover:opacity-50 transition duration-500"></div>
              ...
              <span class="text-xl font-black tracking-tight text-white hidden sm:block">
                ROCKET<span class="text-indigo-400">GOALS</span>
              </span>
            </a>
            ...
            <div class="flex items-center gap-4">
              ...
              @if (isLoggedIn()) {
                ...
                <a routerLink="/signup" class="px-5 py-2 bg-indigo-600 text-white text-sm font-bold rounded-full hover:bg-indigo-500 transition-colors shadow-lg shadow-indigo-600/30">
                  Get Started
                </a>
              }
            </div>
      ...
      <main class="hero-section container mx-auto px-6">
        <div class="max-w-5xl mx-auto text-center">
          ...
          <div class="hero-badge">
            <span class="hero-badge-dot" style="background: #6366f1; color: #6366f1;"></span>
          ...
          <!-- Tagline -->
          <p class="hero-tagline bg-gradient-to-r from-indigo-400 to-blue-400 bg-clip-text text-transparent">
            {{ template.tagline }}
          </p>
          ...
          <div class="features-grid max-w-4xl mx-auto">
            @for (feature of template.features; track feature; let i = $index) {
              <div class="feature-card" [style.animation-delay]="(i * 0.1) + 's'">
                <div class="feature-icon" style="background: rgba(99, 102, 241, 0.2); color: #818cf8;">
          ...
          <div class="cta-section">
            <button 
              ...
              class="launch-btn"
              style="background: linear-gradient(135deg, #6366f1 0%, #4f46e5 100%); color: white; box-shadow: 0 20px 60px rgba(99, 102, 241, 0.4);">
              @if (isLaunching()) {
                <span class="spinner"></span>
                <span>Starting...</span>
              } @else {
                <span>🌙</span>
                <span>Begin After Hours</span>
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            @if (!isLoggedIn()) {
              <p class="mt-6 text-sm text-white/40">
                You'll create an account to start building
              </p>
            }
          </div>
        </div>
  ...
  styles: [`
    .moon-glow {
      ...
      width: 200px;
      height: 200px;
      background: radial-gradient(circle, rgba(226, 232, 240, 0.8) 0%, rgba(226, 232, 240, 0.2) 40%, transparent 70%);
      border-radius: 50%;
      filter: blur(20px);
      pointer-events: none;
...
export class MoonlightMakerComponent implements OnInit {
  ...
  protected readonly template: LaunchpadTemplate = LAUNCHPAD_TEMPLATES['moonlight-maker'];
