...
@Component({
  selector: 'app-career-quest',
  standalone: true,
  imports: [CommonModule, RouterLink, AvatarDropdownComponent],
  template: `
    <div class="launchpad-page">
      <!-- Animated Background -->
      <div class="absolute inset-0 bg-gradient-to-br from-slate-950 via-zinc-900 to-neutral-900"></div>
      
      <!-- Document Floating Effect -->
      <div class="floating-docs"></div>
      ...
      <!-- Gradient Orbs -->
      <div class="gradient-orb orb-primary" style="background: radial-gradient(circle, #71717a 0%, transparent 70%);"></div>
      <div class="gradient-orb orb-secondary" style="background: radial-gradient(circle, #52525b 0%, transparent 70%);"></div>
      <div class="gradient-orb orb-accent" style="background: radial-gradient(circle, #a1a1aa 0%, transparent 70%);"></div>
        ...
        <div class="container mx-auto px-6 py-4">
          <div class="flex items-center justify-between max-w-7xl mx-auto">
            <a routerLink="/" class="flex items-center gap-3 group">
              <div class="relative">
                <div class="absolute -inset-1 bg-gradient-to-r from-zinc-600 to-slate-500 rounded-full blur opacity-30 group-hover:opacity-50 transition duration-500"></div>
              ...
              <span class="text-xl font-black tracking-tight text-white hidden sm:block">
                ROCKET<span class="text-zinc-400">GOALS</span>
              </span>
            </a>
            ...
            <div class="flex items-center gap-4">
              ...
              @if (isLoggedIn()) {
                ...
                <a routerLink="/signup" class="px-5 py-2 bg-zinc-600 text-white text-sm font-bold rounded-full hover:bg-zinc-500 transition-colors shadow-lg shadow-zinc-600/30">
                  Get Started
                </a>
              }
            </div>
      ...
      <main class="hero-section container mx-auto px-6">
        <div class="max-w-5xl mx-auto text-center">
          ...
          <div class="hero-badge">
            <span class="hero-badge-dot" style="background: #71717a; color: #71717a;"></span>
          ...
          <!-- Tagline -->
          <p class="hero-tagline bg-gradient-to-r from-zinc-400 to-slate-400 bg-clip-text text-transparent">
            {{ template.tagline }}
          </p>
          ...
          <div class="features-grid max-w-4xl mx-auto">
            @for (feature of template.features; track feature; let i = $index) {
              <div class="feature-card" [style.animation-delay]="(i * 0.1) + 's'">
                <div class="feature-icon" style="background: rgba(113, 113, 122, 0.2); color: #a1a1aa;">
          ...
          <div class="cta-section">
            <button 
              ...
              class="launch-btn"
              style="background: linear-gradient(135deg, #71717a 0%, #52525b 100%); color: white; box-shadow: 0 20px 60px rgba(113, 113, 122, 0.4);">
              @if (isLaunching()) {
            ...
            @if (!isLoggedIn()) {
              <p class="mt-6 text-sm text-white/40">
                You'll create an account to land your dream job
              </p>
            }
          </div>
        </div>
  ...
  styles: [`
    ...
    .floating-docs::before {
      ...
      animation: float-doc 10s ease-in-out infinite;
    }
    ...
    .floating-docs::after {
      ...
      animation: float-doc 12s ease-in-out 2s infinite reverse;
    }
...
export class CareerQuestComponent implements OnInit {
  ...
  protected readonly template: LaunchpadTemplate = LAUNCHPAD_TEMPLATES['career-quest'];
