      ...
      @if (template(); as t) {
        <main class="hero-section container mx-auto px-6 relative z-10">
          <div class="max-w-5xl mx-auto text-center">
            ...
            <!-- Animated Icon -->
            <div class="hero-icon animate-float mb-8">
              <div class="w-24 h-24 mx-auto rounded-[2rem] glass flex items-center justify-center text-5xl shadow-2xl">
                {{ t.icon }}
              </div>
            </div>
            
            <!-- Brand Title -->
            <h1 class="hero-title animate-reveal-text mb-4">
              {{ t.name }}
            </h1>
            
            <!-- Dynamic Tagline -->
            <p class="hero-tagline animate-fade-in mb-8" [style.color]="t.accentColor">
              {{ t.tagline }}
            </p>
            
            <!-- High-Quality Description -->
            <p class="hero-description animate-fade-in delay-200 opacity-70">
              {{ t.description }}
            </p>
            
            <!-- Premium Features Matrix -->
            <div class="features-grid max-w-4xl mx-auto my-16">
            ...
            <!-- Massive CTA Button -->
            <div class="cta-section animate-slide-up">
              <button 
                (click)="launchMission()"
                ...
                @if (isLaunching()) {
                  ...
                  <span class="ml-3 uppercase tracking-widest font-black">Initiating Launch...</span>
                } @else {
              ...
              @if (!isLoggedIn()) {
                <p class="mt-8 text-xs font-bold uppercase tracking-[0.2em] opacity-40">
                  One account. Infinite potential.
                </p>
              }
            </div>
          </div>
