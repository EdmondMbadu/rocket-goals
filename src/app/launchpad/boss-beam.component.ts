...
@Component({
  selector: 'app-boss-beam',
  standalone: true,
  imports: [CommonModule, RouterLink, AvatarDropdownComponent],
  template: `
    <div class="launchpad-page">
      <!-- Animated Background -->
      <div class="absolute inset-0 bg-gradient-to-br from-fuchsia-950 via-pink-900 to-rose-950"></div>
      ...
      <!-- Gradient Orbs -->
      <div class="gradient-orb orb-primary" style="background: radial-gradient(circle, #ec4899 0%, transparent 70%);"></div>
      <div class="gradient-orb orb-secondary" style="background: radial-gradient(circle, #db2777 0%, transparent 70%);"></div>
      <div class="gradient-orb orb-accent" style="background: radial-gradient(circle, #f472b6 0%, transparent 70%);"></div>
        ...
        <div class="container mx-auto px-6 py-4">
          <div class="flex items-center justify-between max-w-7xl mx-auto">
            <a routerLink="/" class="flex items-center gap-3 group">
              <div class="relative">
                <div class="absolute -inset-1 bg-gradient-to-r from-pink-600 to-rose-500 rounded-full blur opacity-30 group-hover:opacity-50 transition duration-500"></div>
              ...
              <span class="text-xl font-black tracking-tight text-white hidden sm:block">
                ROCKET<span class="text-pink-400">GOALS</span>
              </span>
            </a>
            ...
            <div class="flex items-center gap-4">
              ...
              @if (isLoggedIn()) {
                ...
                <a routerLink="/signup" class="px-5 py-2 bg-pink-600 text-white text-sm font-bold rounded-full hover:bg-pink-500 transition-colors shadow-lg shadow-pink-600/30">
                  Get Started
                </a>
              }
            </div>
      ...
      <main class="hero-section container mx-auto px-6">
        <div class="max-w-5xl mx-auto text-center">
          ...
          <div class="hero-badge">
            <span class="hero-badge-dot" style="background: #ec4899; color: #ec4899;"></span>
          ...
          <!-- Tagline -->
          <p class="hero-tagline bg-gradient-to-r from-pink-400 to-rose-400 bg-clip-text text-transparent">
            {{ template.tagline }}
          </p>
          ...
          <div class="cta-section">
            <button 
              ...
              class="launch-btn"
              style="background: linear-gradient(135deg, #ec4899 0%, #db2777 100%); color: white; box-shadow: 0 20px 60px rgba(236, 72, 153, 0.4);">
              @if (isLaunching()) {
                <span class="spinner"></span>
                <span>Building Empire...</span>
              } @else {
                <span>👑</span>
            ...
            @if (!isLoggedIn()) {
              <p class="mt-6 text-sm text-white/40">
                You'll create an account to scale your vision
              </p>
            }
          </div>
        </div>
  ...
  styles: [`
    ...
    .crown-sparkles::before,
    .crown-sparkles::after {
      content: '✨';
      position: absolute;
      font-size: 24px;
...
export class BossBeamComponent implements OnInit {
  ...
  protected readonly template: LaunchpadTemplate = LAUNCHPAD_TEMPLATES['boss-beam'];
