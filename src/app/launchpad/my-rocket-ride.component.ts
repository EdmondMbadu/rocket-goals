...
@Component({
  selector: 'app-my-rocket-ride',
  standalone: true,
  imports: [CommonModule, RouterLink, AvatarDropdownComponent],
  template: `
    <div class="launchpad-page">
      <!-- Animated Background -->
      <div class="absolute inset-0 bg-gradient-to-br from-orange-950 via-red-900 to-rose-950"></div>
      ...
      <!-- Gradient Orbs -->
      <div class="gradient-orb orb-primary" style="background: radial-gradient(circle, #ef4444 0%, transparent 70%);"></div>
      <div class="gradient-orb orb-secondary" style="background: radial-gradient(circle, #dc2626 0%, transparent 70%);"></div>
      <div class="gradient-orb orb-accent" style="background: radial-gradient(circle, #f87171 0%, transparent 70%);"></div>
          ...
          <div class="flex items-center justify-between max-w-7xl mx-auto">
            <a routerLink="/" class="flex items-center gap-3 group">
              ...
              <span class="text-xl font-black tracking-tight text-white hidden sm:block">
                ROCKET<span class="text-red-400">GOALS</span>
              </span>
            </a>
            ...
            <div class="flex items-center gap-4">
              ...
              @if (isLoggedIn()) {
                ...
                <a routerLink="/signup" class="px-5 py-2 bg-red-600 text-white text-sm font-bold rounded-full hover:bg-red-500 transition-colors shadow-lg shadow-red-600/30">
                  Get Started
                </a>
              }
            </div>
      ...
      <main class="hero-section container mx-auto px-6">
        <div class="max-w-5xl mx-auto text-center">
          ...
          <div class="hero-badge">
            <span class="hero-badge-dot" style="background: #ef4444; color: #ef4444;"></span>
          ...
          <!-- Tagline -->
          <p class="hero-tagline bg-gradient-to-r from-red-400 to-orange-400 bg-clip-text text-transparent">
            {{ template.tagline }}
          </p>
          ...
          <div class="cta-section">
            <button 
              ...
              class="launch-btn"
              style="background: linear-gradient(135deg, #ef4444 0%, #dc2626 100%); color: white; box-shadow: 0 20px 60px rgba(239, 68, 68, 0.4);">
              @if (isLaunching()) {
            ...
            @if (!isLoggedIn()) {
              <p class="mt-6 text-sm text-white/40">
                You'll create an account to conquer your ride
              </p>
            }
          </div>
        </div>
...
export class MyRocketRideComponent implements OnInit {
  ...
  protected readonly template: LaunchpadTemplate = LAUNCHPAD_TEMPLATES['my-rocket-ride'];
