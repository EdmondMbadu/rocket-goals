...
export const routes: Routes = [
  ...
  { path: 'profile/:userId', loadComponent: () => import('./profile.component').then(m => m.ProfileComponent) },
  ...
  { path: 'admin/growth-lead', loadComponent: () => import('./admin/growth-lead-admin.component').then(m => m.GrowthLeadAdminComponent) },
  ...
  { path: 'team/:id', loadComponent: () => import('./team-detail.component').then(m => m.TeamDetailComponent) },
